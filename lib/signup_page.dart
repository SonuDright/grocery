          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                // Image network responsive banane ke liye width and height adjust karte hain
                Container(
                  width: screenSize.width * 0.5,
                  height: screenSize.height * 0.2,
                  child: Image.network("https://via.placeholder.com/150"), // Replace with valid image URL
                ),
                SizedBox(height: 10),
                Text(
                  'Enter the password',
